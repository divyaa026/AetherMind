	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-crisis': 'var(--gradient-crisis)',
			...
			keyframes: {
				...
				'liquid-morph': {
					'0%, 100%': { borderRadius: '20% 80% 30% 70%' },
					'25%': { borderRadius: '70% 30% 80% 20%' },
					'50%': { borderRadius: '30% 70% 20% 80%' },
					'75%': { borderRadius: '80% 20% 70% 30%' }
				}
			},
			animation: {
				...
				'pulse-crisis': 'pulse-crisis 1s ease-in-out infinite',
